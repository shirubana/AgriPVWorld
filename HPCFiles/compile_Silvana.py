...
resultsfolder = '/projects/inspire/Golden/'
with open("locationlist", "r") as fp:
    b = json.load(fp)


# Folders where results are and will be saved
savefolder='/home/sayala/JordanWorld/Golden'
...
locations = np.array(['USA_CO_Golden-NREL__724666_TMY3']) # choose specific locations for analysis
...
savefilename = 'Results_Golden.pkl'
...
with open(r'/home/sayala/JordanWorld/ERRORS_compile.txt', 'w') as fp:
    fp.write('\n'.join(errors_all))
