...
def gcs(startdate=None, enddate=None, location=None, hub_height=None, pitch=None, xgap = None, rootPath=None):
    '''
...
if __name__ == "__main__":
    ...
    rootPath = r'/projects/inspire/JordanWorld/'
    ...
    locations = [x for x in locations if x.startswith('USA')]  # 27
    ...
    sim_list = pd.DataFrame(list(product(locations[0:1],hub_height, pitch, xgap)),
