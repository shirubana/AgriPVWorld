...
poswanted_hawaii = []
poswanted_alaska = []
mmonth = 4 # 0 - May, 1 - June, 2 - July, 3 - August, 4 - September
testbed = 2 # 0 - underpanel, 1 - TBA, 2 - TBB, 3 - TBC
...
plt.tight_layout()
plt.savefig('gap_dist_USA_hist.png', dpi=600)
plt.savefig('gap_dist_USA_hist.pdf')
...
continental_ax.set_title('Ground Irradiance Testbed B, Month of September', fontsize=14, y=0.95)

plt.tight_layout()
plt.savefig('AgriPV_TestbedA_September.png', dpi=600)
